  ...
  modalContainer.innerHTML = `
     ...
     <div 
        class="modal-box">
         ...
         <p>◎ 평점: ${vote}</p>
         <p>◎ 줄거리:${
           overview !== "" ? overview : "줄거리 정보가 존재하지 않습니다."
         }</p>
     </div>
...
const popularMoive = () => {
  ...
  url = new URL(
    "https://api.themoviedb.org/3/movie/popular?api_key=dd5b2707a7e0bb5f2a03f34ba3f049bc&language=ko&page=1"
  );
  Deduplication();
};
popularMoive();
...
const recentMovie = () => {
  ...
  url = new URL(
    "https://api.themoviedb.org/3/discover/movie?api_key=dd5b2707a7e0bb5f2a03f34ba3f049bc&language=ko&sort_by=release_date.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate"
  );
  Deduplication();
};
...
const koreanMovie = () => {
  ...
  url = new URL(
    "https://api.themoviedb.org/3/discover/movie?api_key=dd5b2707a7e0bb5f2a03f34ba3f049bc&language=ko&sort_by=release_date.desc&include_adult=false&include_video=false&page=1&with_original_language=ko&with_watch_monetization_types=flatrate"
  );
  Deduplication();
};
...
const oldMovie = () => {
  ...
  url = new URL(
    "https://api.themoviedb.org/3/discover/movie?api_key=dd5b2707a7e0bb5f2a03f34ba3f049bc&language=ko&sort_by=release_date.asc&include_adult=false&include_video=false&page=1&with_original_language=&with_watch_monetization_types=flatrate"
  );
  Deduplication();
};
...
const searchMovie = (searchVal: string) => {
  ...
  url = new URL(
    `https://api.themoviedb.org/3/search/movie?api_key=dd5b2707a7e0bb5f2a03f34ba3f049bc&language=ko&query=${searchVal}&page=1`
  );
  Deduplication();
};
